...
style.textContent=`
.color-row.has-hex-code{grid-template-columns:46px minmax(88px,1fr) minmax(104px,1.15fr) 58px;align-items:center}
...
@media(max-width:1100px){.color-row.has-hex-code{grid-template-columns:46px minmax(82px,1fr) minmax(96px,1.05fr) 54px;gap:5px}.color-row.has-hex-code .button{padding-left:7px;padding-right:7px;font-size:9px}}
