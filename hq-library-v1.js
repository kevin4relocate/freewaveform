...
function open(){const m=ensureModal();m.hidden=false;m.style.display='grid';m.setAttribute('aria-hidden','false');load()}
...
window.__FW_HQ_LIBRARY={open,close:closeModal,refresh:load};
})();
